export default function FooterLp() {
  return (
    <div>
      <footer className="bg-gray-100 dark:bg-green-900 px-32">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <div className="text-start font-bold mb-4">
                Universitas Insan Pembangunan Indonesia
              </div>
              <div className="text-start text-sm">
                Alamat - Jl. Raya Serang No.Km.10, Kadu Jaya, Kec. Curug,
                Kabupaten Tangerang, Banten 15810<br></br>
                No Telp (021) 59492836
              </div>
            </div>
